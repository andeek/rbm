...
may express the model probabilities as \[
...
in an RBM model, the uncertainty in estimated model parameters becomes
impossible to assess realistically and further, the model can lose
useful application to prediction problems (e.g., realistic predictive
