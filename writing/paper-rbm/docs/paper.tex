...
conclude with a discussion in Section \ref{discussion}. Supplementary
online material provides proofs for results on RBM parameterizations and
data codings described in Section \ref{data-encoding}.
...
(\protect\hyperlink{ref-kaplan2016propriety}{2016}). These findings also
...
Contrastive Divergence.'' \emph{Neural Computation} 14 (8). MIT
Press:1771--1800.
...
Kaplan, Andee, Daniel Nordman, and Stephen Vardeman. 2016. ``On the
Propriety of Restricted Boltzmann Machines.'' \emph{arXiv Preprint
arXiv:1612.01158}.
