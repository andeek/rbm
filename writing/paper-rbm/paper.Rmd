...
For simplicity, consider a model with two visible variables $(V_1,V_2)$ and one hidden $H_1$ so that there are four possible data realizations for $(V_1,V_2)$  given by $(\pm 1, \pm 1)$, and we may express the model probabilities as
$$
