...
which potentially could be small.  Such instability is often due to a complex interaction between
the model statistics used  (i.e., how numerous and large these may become) and the number and magnitudes of
parameters  in the model formulation.  For many FOES models, the possibility exists, at least in principle, to constraint parameters in a way 
balances their potential contributions  against those of model statistics in order to prevent   probability  instabilities.
  The FOES model class is quite broad
and, in developing such models for large data sets, some
