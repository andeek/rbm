...
$$
Again like the RBM case, the DBM model specification is an example of a FSFS model.
...
S-unstable FSFS model sequences may be undesirable for several reasons. One is that small changes in data can lead to very large changes in probability. Consider, for example, the quantity given by
$$
