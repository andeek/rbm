...
$$ 
for fixed positive integers $k$ and $L$ denoting the dimensions of the parameter, $\boldsymbol \lambda \in \Lambda \subset \mathbb{R}^{k}$ and natural parameter $\boldsymbol \eta : \mathbb{R}^k \mapsto \mathbb{R}^L$ spaces, $\boldsymbol g_N : \mathcal{X}^N \mapsto \mathbb{R}^L$ a vector of sufficient statistics, 
$$
