...
$$ 
for fixed positive integers $k$ and $L$ denoting the dimensions of the parameter and natural parameters spaces respectively, $\boldsymbol \lambda \in \Lambda \subset \mathbb{R}^{k}$, $\boldsymbol \eta : \mathbb{R}^k \mapsto \mathbb{R}^L$, $\boldsymbol g : \mathcal{X}^N \mapsto \mathbb{R}^L$ a vector of sufficient statistics, 
$$
